...
# NeutronaWand Upload and Monitor Script
# This script compiles, uploads, and monitors the NeutronaWand firmware in one go

set -e

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PORT="/dev/cu.usbmodem832301"
BAUD="115200"
ENV="esp32s3"

echo "=========================================="
echo "NeutronaWand Upload & Monitor"
echo "=========================================="
